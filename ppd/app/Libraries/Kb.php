...
class Kb
{
    ...
    public function totalArticlesInCat($category_id, $public=true)
    {
        return $this->articlesModel->where('category', $category_id)
            ->countAllResults();
    }
    public function totalArticlesInTop($topic_id)
    {
        return $this->articlesModel->where('topic', $topic_id)
            ->countAllResults();
    }
    ...
    public function addArticle($title, $content, $category, $public)
    {
        ...
        $this->articlesModel->protect(true);
        return $this->articlesModel->getInsertID();
    }
