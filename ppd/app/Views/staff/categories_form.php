...
?>
    ...
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
            ...
            <h3 class="page-title"><?php echo isset($category) ? lang('Admin.cat.editCategory') : lang('Admin.cat.newCategory');?></h3>
        </div>
    </div>
    <!-- End Page Header -->
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <a href="<?php echo site_url(route_to('staff_categories'));?>" class="btn btn-secondary"><?php echo lang('Admin.form.goBack');?></a>
            </div>
            <?php
            echo form_close();
            ?>
