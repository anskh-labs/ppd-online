    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="subject" class="form-control" value="<?php echo esc(set_value('subject', $template->{'subject_'.$locale}));?>">
            </div>
            <div class="form-group">
                <textarea name="message" id="messageBox"><?php echo set_value('message', $template->{'message_'.$locale});?></textarea>
            </div>
            <div class="form-group">
