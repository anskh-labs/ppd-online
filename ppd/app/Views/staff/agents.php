...
<div class="card mb-3">
    <div class="card-header">
        <div class="row">
            ...
            <?php if (staff_data('create_agents') == 1) : ?>
                ...
                <?php foreach ($agents_list as $agent) : ?>
                    <tr>
                        <td>
                            ...
                            <small><?php echo ($agent->role_name == 'admin' ? '<span class="text-success">' . $agent->role_name . '</span>' : $agent->role_name); ?></small>
                        </td>
                        <td>
                        ...
                        <td>
                            <?php if (staff_data('change_agents') == 1 && staff_data('id') != $agent->id) : ?>
                                <div class="btn-group">
