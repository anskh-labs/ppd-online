...
<head>
    ...
    <title>Staff PPD Control Panel</title>
...
<body class="h-100">
        ...
        <div class="row">
            ...
            <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
                <div class="main-navbar sticky-top bg-white">
                    ...
                    <nav class="navbar align-items-stretch navbar-light flex-md-nowrap p-0">
                        ...
                        <ul class="navbar-nav border-left flex-row ">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-nowrap px-3 mt-2" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                    <img src="<?= base_url('assets/helpdeskz/images/lang/' . $locale . '.png') ?>" alt="" height="11" class="mr-2">
                                    <span class="d-none d-md-inline-block"><?= lang('Client.menu.' . $locale) ?></span></a>
                                <div class="dropdown-menu">
                                    <a href="<?= change_locale_url($locale) ?>" class="dropdown-item">
                                        <img src="<?= base_url('assets/helpdeskz/images/lang/' . change_lang($locale) . '.png') ?>" alt="" height="11" class="mr-2">
                                        <span class="d-none d-md-inline-block"><?= lang('Client.menu.' . change_lang($locale)) ?></span></a>
                                </div>
                            </li>
                        </ul>
                        <nav class="nav">
                ...
                <footer class="main-footer d-flex mt-3 p-2 px-3 bg-white border-top">
                    <span class="copyright ml-auto my-auto mr-2">Copyright © <?php echo date('Y'); ?> BPS Kab. Rokan Hulu, powered by
    ...
    <script>
        ...
        var langCatConfirmation = '<?php echo addcslashes(lang('Admin.cat.removeConfirmation'), "'"); ?>';
    ...
    echo script_tag('assets/components/jquery/jquery.min.js') .
        ...
        script_tag('assets/components/highcharts/highcharts.js') .
        script_tag('assets/components/highcharts/data.js') .
        script_tag('assets/components/highcharts/drilldown.js');
