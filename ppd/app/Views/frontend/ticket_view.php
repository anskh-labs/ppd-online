            ...
            <div class="row">
                <div class="col-12">
                    <ol class="nav py-2" style="background-color: transparent!important;">
                        ...
                        <li class="breadcrumb-item text-light"><a href="<?= site_url(route_to('view_tickets')) ?>"><?= lang('Client.viewTickets.menu'); ?></a></li>
                        <li class="breadcrumb-item text-light current"><a href="#"><?= $ticket->id ?></a></li>
                    </ol>
                </div>
            </div>
        </nav>
        ...
        <div class="row mt-3">
            <div class="col-lg-4">
                <div class="form-group">
                    <label><?php echo lang('Client.form.topic'); ?></label>
                    <input type="text" value="<?php echo $ticket->topic_name; ?>" class="form-control" readonly>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
