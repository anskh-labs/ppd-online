...
<div class="row mb-5">
    <div class="col-lg-8">
        ...
        <div class="form-group">
            <label>
                <?php echo lang('Client.form.topic'); ?>
            </label>
        ...
        <div class="form-group">
            <label class="<?php echo ($validation->hasError('message') ? 'text-danger' : ''); ?>">
                <?php echo lang('Client.form.message'); ?> <span class="text-danger">*</span>
            </label>
